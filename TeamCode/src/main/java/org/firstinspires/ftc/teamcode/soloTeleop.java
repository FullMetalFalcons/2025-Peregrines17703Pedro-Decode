...
public class soloTeleop extends OpMode {
    ...
    public void loop() {
        ...
        boolean beltBown = gamepad1.dpad_down;
        ...
        double launch_ball = gamepad1.right_trigger;
        double reverse_launcher = gamepad1.left_trigger;
        if(launch_ball > .3)
        {
        ...
        boolean pusherIn = gamepad1.dpad_right;
        boolean pusherOut = gamepad1.dpad_left;
        ...
        telemetry.addData("pos X", pinX);
        telemetry.addData("pos Y", pinY);
